  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 pt-1 flex-wrap">
        ...
        <img src="/payments/visa.svg" alt="Visa" className="h-7 w-auto" />
        <img src="/payments/mastercard.svg" alt="Mastercard" className="h-7 w-auto" />
        <img src="/payments/amex.svg" alt="American Express" className="h-7 w-auto" />
        <img src="/payments/apple-pay.svg" alt="Apple Pay" className="h-7 w-auto" />
        <img src="/payments/google-pay.svg" alt="Google Pay" className="h-7 w-auto" />
        <img src="/payments/paypal.svg" alt="PayPal" className="h-7 w-auto" />

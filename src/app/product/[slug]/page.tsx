    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "How Long Does Shipping Take?", acceptedAnswer: { "@type": "Answer", text: "We offer free tracked shipping on all orders, delivered in 1–5 business days depending on how far your state is from our Illinois warehouse. Orders placed before 1pm CT on a business day are shipped the same day." } },
          { "@type": "Question", name: "Is Tracking Available?", acceptedAnswer: { "@type": "Answer", text: "Yes, you will receive tracking updates via email." } },

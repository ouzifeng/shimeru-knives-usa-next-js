    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntity: [
          ...
          { "@type": "Question", name: "Are You A Dropshipping Site?", acceptedAnswer: { "@type": "Answer", text: "Absolutely not! We hold our own branded inventory in our US fulfillment partner's warehouse in Illinois, and every US order is picked, packed and shipped from there with USPS tracking. Returns are managed through our Returns & Refunds page." } },
